...
t=dict(a)
# 3.2)Используя функцию zip: # если длина списков будет разной, 
# то лишнее просто не будет учитываться в словаре
a = ['a', 'b', 'c']
b = [1, 2, 3]
d = dict(zip(a, b))
# 3.3) С помощью генераторов  (comprehensions): если длина 
# списков будет разной, то лишнее просто не будет учитываться в словаре
a = ['a', 'b', 'c']
b = [1, 2, 3]
d = {
    i_a: i_b
...
if d.get('a', {}).get('b',{}).get('c', {}): #- проверяет есть ли значение в ключе 'c' 
# в вложенном словаре d = {'a': {'b': {'c': 'x'}}}
